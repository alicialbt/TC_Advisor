...
<html>
  ...
  <head>
    ...
    <script src="../js/liste_infos_pays_stage.js"></script>
          ...
          <div class="row">
           ...
           <!-- Sidebar -->
            ...
            <div class="formulaire">
    				...
    				<div id="infostage"></div>
            
            
            <div id="introstage"></div>
            <SELECT id="liste_entreprise" onchange="checkFieldStage()"><OPTION value =''></option></SELECT>
            
            
            
            <div id="infoentreprise"></div>
