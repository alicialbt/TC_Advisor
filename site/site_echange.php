...
<head>
  ...
  <script src="../js/jquery.js"></script>
    <script src="../js/liste_infos_echanges.js"></script>
            ...
            <!-- Content -->
              <div id=content" class="8u skel-cell-important">
                <section>
                  ...
                  <div id="introuniversites"></div>
                  <SELECT id="liste_universites" onchange="checkFieldEchange()"><OPTION value =''></option></SELECT>
                  
                  <div id="affichage_universites"></div>
